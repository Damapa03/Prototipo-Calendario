...
fun obtenerDiasMes(numMes: Int = 0, numAnio: Int = 0): Int {
    val fechaActual = diaActual()
    val mes = fechaActual.plus(DatePeriod(months = numMes)).month
    val anio = fechaActual.plus(DatePeriod(years = numAnio)).year
...
fun diaSemana(dia: Int, mes: Int, anio: Int): DayOfWeek {
    return LocalDate(anio, mes, dia).dayOfWeek
}
